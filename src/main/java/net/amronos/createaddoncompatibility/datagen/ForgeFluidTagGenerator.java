...
import net.amronos.createaddoncompatibility.Tags.ForgeTags;
...
public class ForgeFluidTagGenerator extends FluidTagsProvider {
    public ForgeFluidTagGenerator(PackOutput p_255941_, CompletableFuture<HolderLookup.Provider> p_256600_, ExistingFileHelper existingFileHelper) {
